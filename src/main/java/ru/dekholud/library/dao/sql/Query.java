...
public class Query {
    ...
    public static final String ADD_BOOK = "INSERT INTO book (name, author, year, person_id) values (?,?,?,?)";
    public static final String UPDATE_BOOK_BY_ID = "UPDATE book SET name=?, author=?, year=?, person_id=? where id=?";
    ...
    public static final String ADD_PERSON = "INSERT INTO person (fio, year_of_birth) values (?,?)";
