package ru.dekholud.library.config;
...
@Configuration
@ComponentScan("ru.dekholud.library")
@EnableWebMvc
...
public class SpringConfig implements WebMvcConfigurer {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setDriverClassName(Objects.requireNonNull(environment.getProperty("db.driver.class")));
